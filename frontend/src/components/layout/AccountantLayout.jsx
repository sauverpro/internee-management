...
import { IconLayoutDashboard, IconCreditCard, IconLogout, IconBriefcase } from '@tabler/icons-react'
...
const navGroups = [
  {
    section: 'Finance',
    items: [{ label: 'Dashboard', icon: IconLayoutDashboard, to: '/accountant/dashboard' }],
  },
]
      ...
      <aside className="flex flex-col w-60 bg-white border-r border-gray-200 flex-shrink-0">
        <div className="flex items-center gap-2.5 px-5 py-4 border-b border-gray-100">
          <div className="p-1.5 bg-teal-600 rounded-lg">
            <IconBriefcase size={17} className="text-white" />
          </div>
        ...
        <div className="p-4 border-t border-gray-100">
          <div className="flex items-center gap-2.5 mb-3">
            ...
            <div className="min-w-0">
              <p className="text-sm font-medium text-gray-800 truncate">{profile?.full_name ?? 'Accountant'}</p>
