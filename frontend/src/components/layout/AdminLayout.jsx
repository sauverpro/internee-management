...
import { IconLayoutDashboard, IconUsers, IconUserCheck, IconBook, IconAdjustments, IconCreditCard, IconLogout, IconBriefcase, IconCalculator } from '@tabler/icons-react'
import { useAuth } from '../../context/AuthContext'
import Avatar from '../ui/Avatar'

const navGroups = [
  { section: 'Overview', items: [{ label: 'Dashboard', icon: IconLayoutDashboard, to: '/admin/dashboard' }] },
  { section: 'Management', items: [
    { label: 'Supervisors', icon: IconUsers, to: '/admin/supervisors' },
    { label: 'Accountants', icon: IconCalculator, to: '/admin/accountants' },
    { label: 'Interns', icon: IconUserCheck, to: '/admin/interns' },
    { label: 'Courses', icon: IconBook, to: '/admin/courses' },
    { label: 'Negotiated rates', icon: IconAdjustments, to: '/admin/rates' },
  ]},
  { section: 'Finance', items: [{ label: 'Payments', icon: IconCreditCard, to: '/admin/payments' }] },
]
