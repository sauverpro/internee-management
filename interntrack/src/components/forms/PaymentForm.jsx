    ...
    <form onSubmit={handleSubmit(submit)} className="space-y-4">
      {registration && (
        <div className="rounded-lg bg-gray-50 border border-gray-200 px-4 py-3">
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            {registration.course_name} · Balance:{' '}
            <span className="font-semibold text-red-600">
              RWF {Number(registration.balance).toLocaleString()}
            </span>
          </p>
        </div>
      )}
      ...
      <div>
        ...
        <input
          ...
          className={errors.amount_paid ? 'input-error' : 'input'}
      ...
      <div>
        ...
        <input
          ...
          className={errors.payment_date ? 'input-error' : 'input'}
        />
