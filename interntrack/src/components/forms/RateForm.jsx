  ...
  return (
    <form onSubmit={handleSubmit(submit)} className="space-y-4">
      <div className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
        <strong>Note:</strong> Existing intern registrations will NOT be affected — their amount due is already locked at registration.
      </div>
      ...
      <div>
        ...
        <input
          ...
          className={errors.agreed_amount ? 'input-error' : 'input'}
      ...
      <div>
        ...
        <textarea rows={3} {...register('notes')} className="input resize-none" placeholder="Any additional context…" />
      </div>
