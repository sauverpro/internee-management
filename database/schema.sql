-- InternTrack — Pure PostgreSQL Schema (no Supabase extensions)
-- Run this in your PostgreSQL database (local or Supabase SQL editor)
...
-- amount_due is snapshotted at creation and immutable.
-- ─────────────────────────────────────────────
...
-- ─────────────────────────────────────────────
-- PAYMENTS (each row = one payment event)
-- ─────────────────────────────────────────────
...
-- ─────────────────────────────────────────────
-- VIEW: intern payment summary
-- Balance and payment_status are always computed — never stored.
-- ─────────────────────────────────────────────
...
--   cd backend
--   npm install
--   node scripts/create-user.js admin@example.com yourpassword admin "Admin Name"
-- ─────────────────────────────────────────────
